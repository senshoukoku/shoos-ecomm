    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen ? (
        ...
        <button
          ...
          className="group relative w-14 h-14 bg-accent text-surface rounded-full flex items-center justify-center shadow-lg hover:bg-accent-dark transition-all duration-300 hover:scale-105 animate-pulse-glow"
        >
          <svg
