...
- Name: e2e.spec.ts >> Sole Heaven - Full E2E Test Suite >> API Endpoints >> GET /api/products should return products
- Location: tests\e2e.spec.ts:421:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/api/products?page=1&limit=4
Call log:
  - navigating to "http://localhost:3001/api/products?page=1&limit=4", waiting until "load"
