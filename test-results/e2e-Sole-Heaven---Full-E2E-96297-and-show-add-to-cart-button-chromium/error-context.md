...
- Name: e2e.spec.ts >> Sole Heaven - Full E2E Test Suite >> Product Detail (/products/[id]) >> should select size and show add to cart button
- Location: tests\e2e.spec.ts:114:9
