...
- Name: e2e.spec.ts >> Sole Heaven - Full E2E Test Suite >> Auth Protection >> should redirect to login when accessing checkout without auth
- Location: tests\e2e.spec.ts:403:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/checkout
Call log:
  - navigating to "http://localhost:3001/checkout", waiting until "load"
