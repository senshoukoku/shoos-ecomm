...
- Name: e2e.spec.ts >> Sole Heaven - Full E2E Test Suite >> API Endpoints >> GET /api/auth/session should return session info
- Location: tests\e2e.spec.ts:430:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/api/auth/session
Call log:
  - navigating to "http://localhost:3001/api/auth/session", waiting until "load"
