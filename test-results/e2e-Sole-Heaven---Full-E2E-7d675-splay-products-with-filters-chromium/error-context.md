...
- Name: e2e.spec.ts >> Sole Heaven - Full E2E Test Suite >> Products Catalog (/products) >> should load and display products with filters
- Location: tests\e2e.spec.ts:35:9
